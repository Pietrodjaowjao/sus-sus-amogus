...
class Note extends FlxSprite
{
	...
	public static var scales:Array<Float> = [0.9, 0.85, 0.8, 0.7, 0.66, 0.6, 0.55, 0.50, 0.46, 0.42, 0.40, 0.36];
	...
	public static var keysShit:Map<Int, Map<String, Dynamic>> = [
		...
		11=> ["letters" => ["A", "B", "C", "D", "J", "N", "M", "F", "G", "H", "I", "J"], "anims" => ["LEFT", "DOWN", "UP", "RIGHT", "LEFT", "UP", "RIGHT", "LEFT", "DOWN", "UP", "RIGHT", "UP"],
			 "strumAnims" => ["LEFT", "DOWN", "UP", "RIGHT", "CIRCLE", "CIRCLE", "CIRCLE", "LEFT", "DOWN", "UP", "RIGHT", "SPACE"], "pixelAnimIndex" => [0, 1, 2, 3, 9, 13, 12, 5, 6, 7, 8, 9]]
	];
	...
	public static var pixelScales:Array<Float> = [1.2, 1.15, 1.1, 1, 0.9, 0.83, 0.8, 0.74, 0.7, 0.6, 0.55, 0.4];
