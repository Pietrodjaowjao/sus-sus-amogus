...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItemsOG:Array<String> = ['Resume', 'Restart Song', 'Exit to menu', 'Edit Map', 'End Song'];
	...
	public function new(x:Float, y:Float)
	{
		...
		ChartEditor = new FlxSprite().loadGraphic(Paths.image('menuDesat'));
		Chartditor.antialiasing = ClientPrefs.globalAntialiasing;
		add(ChartEditor);
		ChartEditor.screenCenter();
	~
